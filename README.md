[**Solidarity with those who fight for justice and equality.**](
  https://nodejs.org/en/black-lives-matter/
) ✊✊🏻✊🏼✊🏽✊🏾✊🏿

👋 Hey! I'm a [Solution Engineer](
  https://medium.com/@safonand/what-is-a-technical-solutions-engineer-e3d4324efec
) at [PDFTron](https://www.pdftron.com/), an advocate for [clean code](
  https://imgs.xkcd.com/comics/good_code.png
) 🧹, [well structured commits](
  https://tbaggery.com/2008/04/19/a-note-about-git-commit-messages.html
) ✨, and fitting a problem to a tool, rather than fitting a tool to a problem
🛠️.
